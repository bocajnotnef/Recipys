...
# Date: 12/27/16
#
# Script to rip recipes from given url and turn them into RST files. Works only with 
# AllRecipes url.
#
...
for i in range(len(dish_name)):
    title_line = title_line + "=" # Title underline must match the length of the title
